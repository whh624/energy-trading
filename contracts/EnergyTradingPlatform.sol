...
contract EnergyTradingPlatform {
    ...
    mapping(uint256 => PBFTState) public pbftStates;
    ...
    function prePrepare(uint256 _orderId) external orderExists(_orderId) {
    ...
    function prepare(uint256 _orderId) external orderExists(_orderId) {
    ...
    function commit(uint256 _orderId) external orderExists(_orderId) {
